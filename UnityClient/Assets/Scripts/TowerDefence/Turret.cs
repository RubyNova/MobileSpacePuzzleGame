...
public class Turret : MonoBehaviour
{
    ...
    [FormerlySerializedAs("Damagable?")] [SerializeField] private bool _canBeDamaged;
    [FormerlySerializedAs("start Health")] [SerializeField] private float _startHealth = 200;
    ...
    [FormerlySerializedAs("Attackers")] [SerializeField] private Text _attackerText;
    ...
    private void UpdateTarget()
    {
        ...
        if (isDisabled)
        {
            _attackerText.text = "Disabled";
        }

        if (!isDisabled)
        {
            _attackerText.text = attackers.ToString();
    ...
    public void Update()
    {
        ...
        Vector3 rotation = Quaternion.Lerp(_partToRotate.rotation, lookRotation, Time.deltaTime * _turnSpeed)
            .eulerAngles;
        ...
        {
            _partToRotate.rotation = Quaternion.Euler(30f, 0f, 0f);
        }
